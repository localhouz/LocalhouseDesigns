...
export const restaurantPrototypes: RestaurantPrototype[] = [
  ...
  },
  {
    ...
    summary: 'A market-first landing page grounded in Bodean\'s public positioning around fresh seafood, in-house specialties, scratch breads, and a clearer split between shopping the market and reserving dinner.',
    heroTitle: 'Make the market the reason to visit.',
    heroSubtitle: 'Bodean already presents itself as a long-running seafood market and restaurant. This concept brings that story forward with a cleaner first screen, stronger market emphasis, and a more polished path into dinner reservations.',
    ...
    marketLanding: {
      ...
      heroSubtext: 'A rebuilt front door for Tulsa\'s long-running seafood market and restaurant, using Bodean\'s own public story around fresh fish, shellfish, house specialties, and dinner service that starts at 5pm.',
      heroImage: 'https://images.squarespace-cdn.com/content/v1/5217c009e4b0564f9830b82f/1377288832621-SMIDHHJWKB7F99X8G95G/Bodean-dinedesign-18.jpg',
      marketImage: 'https://images.squarespace-cdn.com/content/v1/5217c009e4b0564f9830b82f/1385928989424-CNDN3VNX7OPGFQQWCM7D/BodeanMarket-22.jpg',
      diningImage: 'https://images.squarespace-cdn.com/content/v1/5217c009e4b0564f9830b82f/1377289267853-XUQE3UXWE268P6TGO4ZW/Bodean-dinedesign-26.jpg',
      freshHeadline: 'Fresh fish, shellfish, and market specials should lead the page instead of sitting beneath a long inventory list.',
      marketIntroBody: 'Bodean\'s public site already does the hard part: it talks about fresh fish and shellfish, smoked salmon made in house, salads and sauces, daily breads, and pantry staples. This concept turns that into a cleaner, more premium market landing page.',
      departmentHeadline: 'Fresh seafood, house-made staples, and pantry goods organized the way shoppers actually scan them.',
      diningHeadline: 'The restaurant side should feel like a natural extension of the market.',
      diningBody: 'Dinner service begins at 5pm, and the dining room already carries the same seafood-first story as the market. This concept gives that side of the business a more polished reservation path and a stronger connection to the market experience.',
      diningBullets: ['Dinner service begins at 5pm', 'Fresh seafood and shellfish lead the story', 'Private dining is already part of the offering'],
      diningCardTitle: 'Raw bar, fresh catch, and seafood-house classics.',
      diningCardBody: 'Give the restaurant side a cleaner reservation push without making it compete with the market story.',
      visitIntroHeadline: 'Come for the market. Stay for dinner.',
      visitIntroBody: 'A stronger homepage should make both sides of the business obvious right away: shop the seafood case, or move straight into a dinner reservation.',
      visitMarketBody: 'Fresh fish, shellfish, prepared foods, scratch breads, house sauces, and gourmet pantry staples.',
      visitRestaurantBody: 'Dinner reservations, seafood-house atmosphere, and a clearer path for guests planning a night out.'
    }
  },
  {
    slug: 'kilkennys',
