...
export const serverRoutes: ServerRoute[] = [
  ...
  { path: 'work/north-styles', renderMode: RenderMode.Prerender },
  { path: 'work/norcal-sauce-worx', renderMode: RenderMode.Prerender },
  { path: 'work/local-geo-standard', renderMode: RenderMode.Prerender },
  { path: 'contact', renderMode: RenderMode.Prerender },
  { path: 'local-geo-audit', renderMode: RenderMode.Prerender },
  { path: 'broken-arrow-web-design', renderMode: RenderMode.Prerender },
  { path: 'tulsa-web-design', renderMode: RenderMode.Prerender },
  { path: 'local-seo-for-service-businesses', renderMode: RenderMode.Prerender },
  { path: 'salon-website-design-tulsa', renderMode: RenderMode.Prerender },
  { path: 'tulsa-service-business-websites', renderMode: RenderMode.Prerender },
